...
class AdvancedXLSXOptimizer:
    ...
    def _should_use_heavy_ai(self) -> bool:
        ...
        print("[XLSX OPTIMIZER] 🚀 IA PESADA SIEMPRE HABILITADA - MODO PERFECTO")
        ...
        try:
            ...
            print("[XLSX OPTIMIZER] ✅ All AI libraries available - PERFECT AI ENABLED")
            return True
        except ImportError as e:
            print(f"[XLSX OPTIMIZER] ⚠️  Missing AI libraries: {e} - fallback to smart mode")
